...
const (
	...
	// errcode raised by APIs that do not return enough error information
	...
	// instead for those errcode).  It must not be
	// used if the caller cannot be identified (use Unauthenticated
	// instead for those errcode).
	...
	// Internal errcode.  Means some invariants expected by underlying
	// system has been broken.  If you see one of these errcode,
